...
from bioinformatics.objects import SetOfPockets, autoLigandPocket
from pyworkflow.utils.path import copyTree

class ProtBioinformaticsAutoLigand(EMProtocol):
    ...
    def predictPocketStep(self):
        ...
        self.runJob(bioinformatics_plugin.getMGLPath('bin/pythonsh'),
                    bioinformatics_plugin.getADTPath('%s.py' % program) + args,
